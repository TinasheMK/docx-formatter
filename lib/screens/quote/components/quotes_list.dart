...
import 'package:smart_admin_dashboard/screens/quote/edit/quote_home_screen.dart';
...
class _QuotesListState extends State<QuotesList> {
  ...
  Future<void> _initInvoices() async {
    invoices = await getInvoices('QUOTATION',dateSort, filter: filter, clientId: filter2);
              ...
              onPressed: () {
                Navigator.of(context).push(new MaterialPageRoute<Null>(
                    builder: (BuildContext context) {
                      return new QuoteHome(title: "Edit Quote: ${userInfo.id}", code: "edit", invoiceId: userInfo.id );
                    },
