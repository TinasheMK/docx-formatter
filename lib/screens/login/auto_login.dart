...
import '../../providers/auth/provider/prefs_provider.dart';
...
AutoDisposeProviderFamily<Map<String, dynamic>?, String>(
        (ref, status) {
      final sharedPref = ref.watch(sharedPreferencesServiceProvider);
      cachedUser = sharedPref.getCachedUserCredentials();
      return sharedPref.getCachedUserCredentials();
    });
...
class LoginAuto extends ConsumerWidget {
  LoginAuto({Key? key}) : super(key: key);
