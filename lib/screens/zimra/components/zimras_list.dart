...
class ZimrasList extends StatefulWidget {
  @override
  _ZimrasListState createState() => _ZimrasListState();
}
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text(
            "Client List (ZIMRA Registration)",
          ...
          children: [
              ...
              onPressed: () {
                Navigator.of(context).push(new MaterialPageRoute<Null>(
                    builder: (BuildContext context) {
                      return new NewZimraHome(title: 'ZIMRA Registration', code: 'wiw', companyId: userInfo.id,);
                    },
            ...
            GestureDetector(
              onTap:(){
                Navigator.of(context).push(new MaterialPageRoute<Null>(
                    builder: (BuildContext context) {
                      return new NewZimraHome(title: "Edit ZIMRA Regitration", code: "edit", companyId: userInfo.id );
                    },
                    fullscreenDialog: true));
              },
