...
class FileSaveHelper {
  ...
  static Future<void> saveAndLaunchFile(
    ...
    if (
      ...
      final Directory directory = Directory('/storage/emulated/0/Documents/Invoices');
      print(directory);
      path = directory.path;
    }
    else {
    ...
    new File(Platform.isWindows ? '$path\\$fileName' : '$path/$fileName').create(recursive: true)
