...
class ProductScreen extends StatefulWidget {
  ProductScreen({required this.title, required this.code, this.invoiceId});
  final String title;
  final int? invoiceId;
  final String code;

  @override
  _ProductScreenState createState() => _ProductScreenState(invoiceId);
}
...
class _ProductScreenState extends State<ProductScreen> with SingleTickerProviderStateMixin {
  ...
  _ProductScreenState(int? this.invoiceId);
  int? invoiceId;
        ...
        child: Container(
          ...
          child: Column(
            children: [
              ...
              ProductHeader(title: widget.title,),
              SizedBox(height: defaultPadding),
              Row(
