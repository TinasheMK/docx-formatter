...
import '../new/new_praz_home_screen.dart';



class PrazsList extends StatefulWidget {
  @override
  _PrazsListState createState() => _PrazsListState();
}

class _PrazsListState extends State<PrazsList> {
          ...
          children: [
              ...
              onPressed: () {
                Navigator.of(context).push(new MaterialPageRoute<Null>(
                    builder: (BuildContext context) {
                      return new NewPrazHome(title: 'Praz Registration', code: 'wiw', companyId: userInfo.id,);
                    },
            ...
            GestureDetector(
              onTap:(){
                Navigator.of(context).push(new MaterialPageRoute<Null>(
                    builder: (BuildContext context) {
                      return new NewPrazHome(title: "Edit Praz Regitration", code: "edit", companyId: userInfo.id );
                    },
                    fullscreenDialog: true));
              },
