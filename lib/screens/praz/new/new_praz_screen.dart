...
import '../../zimra/new/components/zimra_header.dart';
import 'components/praz_header.dart';




class NewPrazScreen extends StatefulWidget {
  NewPrazScreen({required this.title, required this.code, this.companyId});
  final String title;
  final String code;
  final int? companyId;

  @override
  _NewPrazScreenState createState() => _NewPrazScreenState(companyId);
}

// class NewPrazScreen extends StatefulWidget {
class _NewPrazScreenState extends State<NewPrazScreen> with SingleTickerProviderStateMixin {
  _NewPrazScreenState(this.companyId);
